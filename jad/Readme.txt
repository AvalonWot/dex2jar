------------------------------------------------------------------------------------
./jad/jad: error while loading shared libraries: libstdc++-libc6.2-2.so.3: cannot open shared object file: No such file or directory


choice 1 : download
http://archive.debian.net/zh-cn/woody/i386/libstdc++2.10-glibc2.2/download

choice 2 : local resource
libstdc++2.10-glibc2.2_2.95.4-11woody1_i386.deb
double click this deb file will install automatically.
...
https://varaneckas.com/jad/     jad download webset.
