...
.method public constructor <init>(Landroid/content/Context;Lcom/google/vr/internal/controller/ServiceBridge$Callbacks;)V
    ...
    .param p2, "callbacks"    # Lcom/google/vr/internal/controller/ServiceBridge$Callbacks;
    .annotation build Lcom/google/vr/cardboard/annotations/UsedByNative;
    .end annotation
...
.method static synthetic access$000(Lcom/google/vr/internal/controller/ServiceBridge;)V
    .locals 0
    .param p0, "x0"    # Lcom/google/vr/internal/controller/ServiceBridge;
...
.method private doBind()V
    ...
    .line 396
    iget-boolean v1, p0, Lcom/google/vr/internal/controller/ServiceBridge;->isBound:Z
    ...
    invoke-interface {v1}, Lcom/google/vr/internal/controller/ServiceBridge$Callbacks;->onServiceUnavailable()V
...
.method private unregisterListener()V
    ...
    invoke-interface {v1, v2}, Lcom/google/vr/vrcore/controller/api/IControllerService;->unregisterListener(Ljava/lang/String;)Z
    :try_end_0
    ...
    const-string v2, "RemoteException while unregistering listener."
...
.method public onServiceConnected(Landroid/content/ComponentName;Landroid/os/IBinder;)V
    ...
    iput-object v4, p0, Lcom/google/vr/internal/controller/ServiceBridge;->service:Lcom/google/vr/vrcore/controller/api/IControllerService;

    .line 476
    :try_start_0
    iget-object v4, p0, Lcom/google/vr/internal/controller/ServiceBridge;->service:Lcom/google/vr/vrcore/controller/api/IControllerService;

    const/16 v5, 0xb

    invoke-interface {v4, v5}, Lcom/google/vr/vrcore/controller/api/IControllerService;->initialize(I)I
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 486
    sget-object v5, Lcom/google/vr/internal/controller/ServiceBridge;->TAG:Ljava/lang/String;

    const-string v6, "initialize() returned error: "

    invoke-static {v3}, Lcom/google/vr/vrcore/controller/api/ControllerInitResults;->toString(I)Ljava/lang/String;
    ...
    .line 487
    iget-object v4, p0, Lcom/google/vr/internal/controller/ServiceBridge;->callbacks:Lcom/google/vr/internal/controller/ServiceBridge$Callbacks;

    invoke-interface {v4, v3}, Lcom/google/vr/internal/controller/ServiceBridge$Callbacks;->onServiceInitFailed(I)V
    ...
    .line 479
    sget-object v4, Lcom/google/vr/internal/controller/ServiceBridge;->TAG:Ljava/lang/String;

    const-string v5, "Failed to call initialize() on controller service (RemoteException)."
    ...
    invoke-interface {v4}, Lcom/google/vr/internal/controller/ServiceBridge$Callbacks;->onServiceFailed()V
    ...
    .line 498
    .local v0, "clientApiVersion":I
    if-gez v0, :cond_3

    .line 502
    sget-object v4, Lcom/google/vr/internal/controller/ServiceBridge;->TAG:Ljava/lang/String;

    const-string v5, "Failed to get VrCore client API version."
    ...
    invoke-interface {v4, v2}, Lcom/google/vr/internal/controller/ServiceBridge$Callbacks;->onServiceConnected(I)V
    ...
    const-string v6, "com.google.vr.internal.controller.LISTENER_KEY"

    iget-object v7, p0, Lcom/google/vr/internal/controller/ServiceBridge;->controllerListener:Lcom/google/vr/vrcore/controller/api/IControllerListener;

    invoke-interface {v4, v5, v6, v7}, Lcom/google/vr/vrcore/controller/api/IControllerService;->registerListener(ILjava/lang/String;Lcom/google/vr/vrcore/controller/api/IControllerListener;)Z
    ...
    const-string v5, "Failed to register listener."
    ...
    const-string v5, "RemoteException while registering listener."
    ...
    const-string v5, "Recentering is not supported by VrCore API version "
