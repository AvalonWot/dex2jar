...
.method public acquireFrame()Lcom/google/vr/ndk/base/Frame;
    ...
    invoke-virtual {v2}, Lcom/google/vr/ndk/base/Frame;->getNativeFrame()J
    ...
    const-string v3, "Previous frame not submitted"
    ...
    .line 83
    :cond_1
    iget v2, p0, Lcom/google/vr/ndk/base/SwapChain;->currentFrame:I

    add-int/lit8 v2, v2, 0x1

    rem-int/lit8 v2, v2, 0x2

    iput v2, p0, Lcom/google/vr/ndk/base/SwapChain;->currentFrame:I

    .line 84
    iget-wide v2, p0, Lcom/google/vr/ndk/base/SwapChain;->nativeSwapChain:J

    invoke-static {v2, v3}, Lcom/google/vr/ndk/base/GvrApi;->nativeSwapChainAcquireFrame(J)J

    move-result-wide v0

    .line 85
    .local v0, "acquiredNativeFrame":J
    cmp-long v2, v0, v4
...
.method public getBufferSize(ILandroid/graphics/Point;)V
    ...
    .param p2, "sizeOut"    # Landroid/graphics/Point;
