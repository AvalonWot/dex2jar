...
.method public constructor <init>(Landroid/content/Context;Lcom/google/vr/cardboard/DisplaySynchronizer;)V
    ...
    iput-object v1, p0, Lcom/google/vr/ndk/base/GvrApi;->vrParamsProvider:Lcom/google/vr/cardboard/VrParamsProvider;
    ...
    const-string v2, "Native GVR context creation failed, implementation unavailable."
    ...
    .end local v4    # "synchronizerPtr":J
    :cond_0
    ...
    .restart local v4    # "synchronizerPtr":J
    :cond_1
    return-void
.end method
...
.method public static setPoseTrackerForTesting(Lcom/google/vr/ndk/base/GvrApi$PoseTracker;)V
    .locals 0
    .param p0, "tracker"    # Lcom/google/vr/ndk/base/GvrApi$PoseTracker;
...
.method private setViewerParams([B)Z
    .locals 2
    .param p1, "serializedViewerParams"    # [B
...
.method public computeCurrentDisplayMetrics()Landroid/util/DisplayMetrics;
    ...
    .prologue
    .line 944
    iget-object v1, p0, Lcom/google/vr/ndk/base/GvrApi;->displaySynchronizer:Lcom/google/vr/cardboard/DisplaySynchronizer;

    if-nez v1, :cond_0

    .line 945
    iget-object v1, p0, Lcom/google/vr/ndk/base/GvrApi;->context:Landroid/content/Context;
    ...
    invoke-virtual {v1}, Lcom/google/vr/cardboard/DisplaySynchronizer;->getDisplay()Landroid/view/Display;
...
.method public computeDistortedPoint(I[F)[F
    ...
    invoke-direct {p0, v2, v3, p1, p2}, Lcom/google/vr/ndk/base/GvrApi;->nativeComputeDistortedPoint(JI[F)[F
    ...
    const-string v2, "Implementation error: invalid UV coordinates output."
...
.method public createSwapChain([Lcom/google/vr/ndk/base/BufferSpec;)Lcom/google/vr/ndk/base/SwapChain;
    .locals 6
    .param p1, "specs"    # [Lcom/google/vr/ndk/base/BufferSpec;
    ...
    iget-wide v4, v3, Lcom/google/vr/ndk/base/BufferSpec;->nativeBufferSpec:J
    ...
    .line 429
    :cond_0
    new-instance v2, Lcom/google/vr/ndk/base/SwapChain;

    iget-wide v4, p0, Lcom/google/vr/ndk/base/GvrApi;->nativeGvrContext:J

    invoke-static {v4, v5, v1}, Lcom/google/vr/ndk/base/GvrApi;->nativeSwapChainCreate(J[J)J

    move-result-wide v4

    invoke-direct {v2, v4, v5}, Lcom/google/vr/ndk/base/SwapChain;-><init>(J)V

    .line 430
    .local v2, "swapChain":Lcom/google/vr/ndk/base/SwapChain;
    iget-object v3, p0, Lcom/google/vr/ndk/base/GvrApi;->swapChainRefs:Ljava/util/ArrayList;
...
.method public distortToScreen(ILcom/google/vr/ndk/base/BufferViewportList;[FJ)V
    ...
    .param p2, "bufferViewportList"    # Lcom/google/vr/ndk/base/BufferViewportList;
    .param p3, "headSpaceFromStartSpace"    # [F
    .param p4, "texturePresentationTimeNs"    # J
...
.method public getHeadSpaceFromStartSpaceRotation([FJ)V
    .locals 6
    .param p1, "headSpaceFromStartSpaceRotationOut"    # [F
    .param p2, "timeNs"    # J
...
.method public getRecommendedBufferViewports(Lcom/google/vr/ndk/base/BufferViewportList;)V
    .locals 4
    .param p1, "bufferViewportOut"    # Lcom/google/vr/ndk/base/BufferViewportList;
...
.method public getWindowBounds()[I
    ...
    invoke-direct {p0, v2, v3}, Lcom/google/vr/ndk/base/GvrApi;->nativeGetWindowBounds(J)[I

    move-result-object v0

    .line 832
    .local v0, "windowBounds":[I
    array-length v1, v0
    ...
    const-string v2, "Implementation error: invalid window bounds."
...
.method public refreshViewerProfile()V
    ...
    .line 749
    .local v0, "deviceProto":Lcom/google/vrtoolkit/cardboard/proto/nano/CardboardDevice$DeviceParams;
    if-eqz v0, :cond_0
    ...
    invoke-direct {p0, v1}, Lcom/google/vr/ndk/base/GvrApi;->setViewerParams([B)Z
...
.method requestContextSharing(Lcom/google/vr/cardboard/EglReadyListener;)V
    .locals 2
    .param p1, "eglListener"    # Lcom/google/vr/cardboard/EglReadyListener;
...
.method public setDefaultViewerProfile(Ljava/lang/String;)Z
    .locals 2
    .param p1, "viewerProfileUri"    # Ljava/lang/String;
...
.method public shutdown()V
    ...
    .line 281
    iget-object v2, p0, Lcom/google/vr/ndk/base/GvrApi;->swapChainRefs:Ljava/util/ArrayList;
    ...
    .line 282
    .local v0, "ref":Ljava/lang/ref/WeakReference;, "Ljava/lang/ref/WeakReference<Lcom/google/vr/ndk/base/SwapChain;>;"
    ...
    .line 283
    .local v1, "swapChain":Lcom/google/vr/ndk/base/SwapChain;
    if-eqz v1, :cond_0
    ...
    .line 287
    .end local v0    # "ref":Ljava/lang/ref/WeakReference;, "Ljava/lang/ref/WeakReference<Lcom/google/vr/ndk/base/SwapChain;>;"
    .end local v1    # "swapChain":Lcom/google/vr/ndk/base/SwapChain;
    :cond_1
    iget-wide v2, p0, Lcom/google/vr/ndk/base/GvrApi;->nativeGvrContext:J
    ...
    .line 288
    iget-object v2, p0, Lcom/google/vr/ndk/base/GvrApi;->vrParamsProvider:Lcom/google/vr/cardboard/VrParamsProvider;
    ...
    invoke-direct {p0, v2, v3}, Lcom/google/vr/ndk/base/GvrApi;->nativeReleaseGvrContext(J)V
