...
.method public constructor <init>(Landroid/content/Context;Lcom/google/vr/ndk/base/GvrApi;Landroid/content/ComponentName;Lcom/google/vr/ndk/base/DaydreamUtilsWrapper;Ljava/lang/Runnable;Lcom/google/vr/ndk/base/FadeOverlayView;)V
    ...
    .param p4, "daydreamUtils"    # Lcom/google/vr/ndk/base/DaydreamUtilsWrapper;
    .param p5, "closeVrRunnable"    # Ljava/lang/Runnable;
    .param p6, "fadeOverlayView"    # Lcom/google/vr/ndk/base/FadeOverlayView;
...
.method static synthetic access$000(Lcom/google/vr/ndk/base/VrCoreSdkClient;)V
    .locals 0
    .param p0, "x0"    # Lcom/google/vr/ndk/base/VrCoreSdkClient;
...
.method static synthetic access$1000(Lcom/google/vr/ndk/base/GvrApi;Lcom/google/vr/vrcore/common/api/HeadTrackingState;)V
    .locals 0
    .param p0, "x0"    # Lcom/google/vr/ndk/base/GvrApi;
...
.method private doBind()Z
    ...
    .line 214
    iget-boolean v2, p0, Lcom/google/vr/ndk/base/VrCoreSdkClient;->isBound:Z
    ...
    .line 218
    :cond_0
    iget-boolean v2, p0, Lcom/google/vr/ndk/base/VrCoreSdkClient;->shouldBind:Z
    ...
    iput-boolean v1, p0, Lcom/google/vr/ndk/base/VrCoreSdkClient;->isBound:Z
...
.method private doUnbind()V
    ...
    .line 242
    iget-boolean v1, p0, Lcom/google/vr/ndk/base/VrCoreSdkClient;->isResumed:Z

    if-eqz v1, :cond_0

    .line 243
    invoke-direct {p0, v5}, Lcom/google/vr/ndk/base/VrCoreSdkClient;->resumeTracking(Lcom/google/vr/vrcore/common/api/HeadTrackingState;)V
    ...
    .line 247
    :cond_0
    iget-object v1, p0, Lcom/google/vr/ndk/base/VrCoreSdkClient;->gvrApi:Lcom/google/vr/ndk/base/GvrApi;

    invoke-virtual {v1}, Lcom/google/vr/ndk/base/GvrApi;->pauseTrackingGetState()[B

    goto :goto_0

    .line 257
    :cond_1
    iget-object v1, p0, Lcom/google/vr/ndk/base/VrCoreSdkClient;->daydreamManager:Lcom/google/vr/vrcore/common/api/IDaydreamManager;
    ...
    invoke-interface {v1, v2}, Lcom/google/vr/vrcore/common/api/IDaydreamManager;->unregisterListener(Landroid/content/ComponentName;)Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0

    .line 263
    :goto_2
    iput-object v5, p0, Lcom/google/vr/ndk/base/VrCoreSdkClient;->daydreamManager:Lcom/google/vr/vrcore/common/api/IDaydreamManager;

    .line 266
    :cond_2
    iput-object v5, p0, Lcom/google/vr/ndk/base/VrCoreSdkClient;->vrCoreSdkService:Lcom/google/vr/vrcore/common/api/IVrCoreSdkService;

    .line 267
    iget-object v1, p0, Lcom/google/vr/ndk/base/VrCoreSdkClient;->context:Landroid/content/Context;

    iget-object v2, p0, Lcom/google/vr/ndk/base/VrCoreSdkClient;->serviceConnection:Landroid/content/ServiceConnection;
...
.method private static resumeTracking(Lcom/google/vr/ndk/base/GvrApi;Lcom/google/vr/vrcore/common/api/HeadTrackingState;)V
    .locals 1
    .param p0, "gvrApi"    # Lcom/google/vr/ndk/base/GvrApi;
...
.method public launchInVr(Landroid/app/PendingIntent;)Z
    .locals 5
    .param p1, "launchAppPendingIntent"    # Landroid/app/PendingIntent;
    ...
    invoke-interface {v1, p1}, Lcom/google/vr/vrcore/common/api/IDaydreamManager;->deprecatedLaunchInVr(Landroid/app/PendingIntent;)Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v3, "Failed to launch app in VR: "
