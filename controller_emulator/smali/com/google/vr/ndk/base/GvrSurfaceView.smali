...
.method static synthetic access$1000(Lcom/google/vr/ndk/base/GvrSurfaceView;)Landroid/opengl/GLSurfaceView$Renderer;
    .locals 1
    .param p0, "x0"    # Lcom/google/vr/ndk/base/GvrSurfaceView;
...
.method protected onAttachedToWindow()V
    ...
    .line 717
    iget-boolean v2, p0, Lcom/google/vr/ndk/base/GvrSurfaceView;->mDetached:Z

    if-eqz v2, :cond_3

    iget-object v2, p0, Lcom/google/vr/ndk/base/GvrSurfaceView;->mRenderer:Landroid/opengl/GLSurfaceView$Renderer;

    if-eqz v2, :cond_3

    iget-boolean v2, p0, Lcom/google/vr/ndk/base/GvrSurfaceView;->mPreserveGlThreadOnDetachedFromWindow:Z
    ...
    invoke-virtual {v2}, Lcom/google/vr/ndk/base/GvrSurfaceView$GLThread;->getRenderMode()I
    ...
    invoke-virtual {v2}, Lcom/google/vr/ndk/base/GvrSurfaceView$GLThread;->getSwapMode()I

    move-result v1

    .line 724
    :cond_0
    new-instance v2, Lcom/google/vr/ndk/base/GvrSurfaceView$GLThread;

    iget-object v3, p0, Lcom/google/vr/ndk/base/GvrSurfaceView;->mThisWeakRef:Ljava/lang/ref/WeakReference;

    invoke-direct {v2, v3}, Lcom/google/vr/ndk/base/GvrSurfaceView$GLThread;-><init>(Ljava/lang/ref/WeakReference;)V

    iput-object v2, p0, Lcom/google/vr/ndk/base/GvrSurfaceView;->mGLThread:Lcom/google/vr/ndk/base/GvrSurfaceView$GLThread;
    ...
    invoke-virtual {v2, v0}, Lcom/google/vr/ndk/base/GvrSurfaceView$GLThread;->setRenderMode(I)V
    ...
    invoke-virtual {v2, v1}, Lcom/google/vr/ndk/base/GvrSurfaceView$GLThread;->setSwapMode(I)V

    .line 731
    :cond_2
    iget-object v2, p0, Lcom/google/vr/ndk/base/GvrSurfaceView;->mGLThread:Lcom/google/vr/ndk/base/GvrSurfaceView$GLThread;

    invoke-virtual {v2}, Lcom/google/vr/ndk/base/GvrSurfaceView$GLThread;->start()V
    ...
    iput-boolean v2, p0, Lcom/google/vr/ndk/base/GvrSurfaceView;->mDetached:Z
...
.method public setEglReadyListener(Lcom/google/vr/cardboard/EglReadyListener;)V
    .locals 0
    .param p1, "listener"    # Lcom/google/vr/cardboard/EglReadyListener;
...
.method public setGLWrapper(Lcom/google/vr/ndk/base/GvrSurfaceView$GLWrapper;)V
    .locals 0
    .param p1, "glWrapper"    # Lcom/google/vr/ndk/base/GvrSurfaceView$GLWrapper;
