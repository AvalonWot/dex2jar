...
.method constructor <init>(Landroid/content/Context;Lcom/google/vr/ndk/base/DaydreamUtilsWrapper;)V
    .locals 2
    .param p1, "context"    # Landroid/content/Context;
    .param p2, "daydreamUtils"    # Lcom/google/vr/ndk/base/DaydreamUtilsWrapper;
...
.method private static createDefaultCloseButtonRunnable(Landroid/content/Context;Lcom/google/vr/ndk/base/DaydreamUtilsWrapper;)Ljava/lang/Runnable;
    ...
    .param p1, "daydreamUtils"    # Lcom/google/vr/ndk/base/DaydreamUtilsWrapper;
    ...
    .line 189
    :cond_0
    invoke-virtual {p1, v0}, Lcom/google/vr/ndk/base/DaydreamUtilsWrapper;->isDaydreamActivity(Landroid/app/Activity;)Z
    ...
    .line 190
    new-instance v1, Lcom/google/vr/ndk/base/GvrUiLayout$1;

    invoke-direct {v1, v0}, Lcom/google/vr/ndk/base/GvrUiLayout$1;-><init>(Landroid/app/Activity;)V

    goto :goto_0

    .line 203
    :cond_1
    new-instance v1, Lcom/google/vr/ndk/base/GvrUiLayout$2;

    invoke-direct {v1, v0}, Lcom/google/vr/ndk/base/GvrUiLayout$2;-><init>(Landroid/app/Activity;)V
...
.method invokeCloseButtonListener()V
    ...
    invoke-virtual {v1}, Lcom/google/vr/cardboard/UiLayer;->getBackButtonRunnable()Ljava/lang/Runnable;

    move-result-object v0

    .line 141
    .local v0, "closeButtonRunnable":Ljava/lang/Runnable;
    if-eqz v0, :cond_0
...
.method setDaydreamModeEnabled(Z)V
    .locals 2
    .param p1, "daydreamModeEnabled"    # Z
