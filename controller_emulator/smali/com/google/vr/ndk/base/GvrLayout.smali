...
.method constructor <init>(Landroid/content/Context;Lcom/google/vr/ndk/base/GvrApi;Lcom/google/vr/cardboard/DisplaySynchronizer;Lcom/google/vr/cardboard/EglReadyListener;Lcom/google/vr/ndk/base/FadeOverlayView;Lcom/google/vr/ndk/base/DaydreamUtilsWrapper;)V
    .locals 6
    .param p1, "context"    # Landroid/content/Context;
    .param p2, "gvrApi"    # Lcom/google/vr/ndk/base/GvrApi;
    .param p3, "synchronizer"    # Lcom/google/vr/cardboard/DisplaySynchronizer;
    .param p4, "eglReadyListener"    # Lcom/google/vr/cardboard/EglReadyListener;
    .param p5, "fadeOverlayView"    # Lcom/google/vr/ndk/base/FadeOverlayView;
    .param p6, "daydreamUtils"    # Lcom/google/vr/ndk/base/DaydreamUtilsWrapper;
...
.method public constructor <init>(Lcom/google/vr/cardboard/VrContextWrapper;)V
    .locals 6
    .param p1, "contextWrapper"    # Lcom/google/vr/cardboard/VrContextWrapper;
...
.method static synthetic access$000(Lcom/google/vr/ndk/base/GvrLayout;I)V
    .locals 0
    .param p0, "x0"    # Lcom/google/vr/ndk/base/GvrLayout;
    .param p1, "x1"    # I
...
.method private init(Lcom/google/vr/ndk/base/GvrApi;Lcom/google/vr/cardboard/DisplaySynchronizer;Lcom/google/vr/cardboard/EglReadyListener;Lcom/google/vr/ndk/base/FadeOverlayView;Lcom/google/vr/ndk/base/DaydreamUtilsWrapper;)V
    ...
    .param p2, "synchronizer"    # Lcom/google/vr/cardboard/DisplaySynchronizer;
    .param p3, "eglReadyListener"    # Lcom/google/vr/cardboard/EglReadyListener;
    .param p4, "fadeOverlayView"    # Lcom/google/vr/ndk/base/FadeOverlayView;
    .param p5, "daydreamUtils"    # Lcom/google/vr/ndk/base/DaydreamUtilsWrapper;
    ...
    .line 298
    const-string v8, "GvrLayout.init"

    invoke-static {v8}, Lcom/google/vr/ndk/base/TraceCompat;->beginSection(Ljava/lang/String;)V
    ...
    iput-object v8, p0, Lcom/google/vr/ndk/base/GvrLayout;->presentationLayout:Landroid/widget/FrameLayout;

    .line 318
    new-instance v8, Lcom/google/vr/ndk/base/GvrUiLayout;

    invoke-virtual {p0}, Lcom/google/vr/ndk/base/GvrLayout;->getContext()Landroid/content/Context;

    move-result-object v9

    invoke-direct {v8, v9}, Lcom/google/vr/ndk/base/GvrUiLayout;-><init>(Landroid/content/Context;)V

    iput-object v8, p0, Lcom/google/vr/ndk/base/GvrLayout;->uiLayout:Lcom/google/vr/ndk/base/GvrUiLayout;
    ...
    iput-object v8, p0, Lcom/google/vr/ndk/base/GvrLayout;->presentationHelper:Lcom/google/vr/ndk/base/GvrLayout$PresentationHelper;
    ...
    iget-object v8, p0, Lcom/google/vr/ndk/base/GvrLayout;->presentationLayout:Landroid/widget/FrameLayout;

    add-int/lit8 v6, v5, 0x1

    .end local v5    # "viewIndex":I
    .local v6, "viewIndex":I
    invoke-virtual {p0, v8, v5}, Lcom/google/vr/ndk/base/GvrLayout;->addView(Landroid/view/View;I)V

    .line 327
    iget-object v8, p0, Lcom/google/vr/ndk/base/GvrLayout;->uiLayout:Lcom/google/vr/ndk/base/GvrUiLayout;

    add-int/lit8 v5, v6, 0x1

    .end local v6    # "viewIndex":I
    .restart local v5    # "viewIndex":I
    invoke-virtual {p0, v8, v6}, Lcom/google/vr/ndk/base/GvrLayout;->addView(Landroid/view/View;I)V
    ...
    invoke-virtual {p5, v8}, Lcom/google/vr/ndk/base/DaydreamUtilsWrapper;->isDaydreamPhone(Landroid/content/Context;)Z

    move-result v3

    .line 332
    .local v3, "isDaydreamPhone":Z
    if-eqz v3, :cond_0
    ...
    iput-object v8, p0, Lcom/google/vr/ndk/base/GvrLayout;->daydreamTouchListener:Lcom/google/vr/ndk/base/DaydreamTouchListener;

    .line 335
    iget-object v8, p0, Lcom/google/vr/ndk/base/GvrLayout;->uiLayout:Lcom/google/vr/ndk/base/GvrUiLayout;

    iget-object v9, p0, Lcom/google/vr/ndk/base/GvrLayout;->daydreamTouchListener:Lcom/google/vr/ndk/base/DaydreamTouchListener;

    invoke-virtual {v8, v9}, Lcom/google/vr/ndk/base/GvrUiLayout;->setOnTouchListener(Landroid/view/View$OnTouchListener;)V
    ...
    invoke-virtual {p5, v8}, Lcom/google/vr/ndk/base/DaydreamUtilsWrapper;->getComponentDaydreamCompatibility(Landroid/content/Context;)I

    move-result v0

    .line 340
    .local v0, "daydreamCompatibility":I
    if-eqz v0, :cond_9

    move v2, v7

    .line 341
    .local v2, "isDaydreamComponent":Z
    :goto_4
    const/4 v8, 0x2
    ...
    .line 345
    .local v4, "isDaydreamRequiredComponent":Z
    :goto_5
    if-nez v3, :cond_1
    ...
    .line 349
    .end local p4    # "fadeOverlayView":Lcom/google/vr/ndk/base/FadeOverlayView;
    :goto_6
    iput-object p4, p0, Lcom/google/vr/ndk/base/GvrLayout;->fadeOverlayView:Lcom/google/vr/ndk/base/FadeOverlayView;

    .line 350
    iget-object v7, p0, Lcom/google/vr/ndk/base/GvrLayout;->fadeOverlayView:Lcom/google/vr/ndk/base/FadeOverlayView;

    add-int/lit8 v6, v5, 0x1

    .end local v5    # "viewIndex":I
    .restart local v6    # "viewIndex":I
    invoke-virtual {p0, v7, v5}, Lcom/google/vr/ndk/base/GvrLayout;->addView(Landroid/view/View;I)V
    ...
    iget-object v8, p0, Lcom/google/vr/ndk/base/GvrLayout;->fadeOverlayView:Lcom/google/vr/ndk/base/FadeOverlayView;

    invoke-virtual {p0, v7, p1, p5, v8}, Lcom/google/vr/ndk/base/GvrLayout;->createVrCoreSdkClient(Landroid/content/Context;Lcom/google/vr/ndk/base/GvrApi;Lcom/google/vr/ndk/base/DaydreamUtilsWrapper;Lcom/google/vr/ndk/base/FadeOverlayView;)Lcom/google/vr/ndk/base/VrCoreSdkClient;

    move-result-object v7

    iput-object v7, p0, Lcom/google/vr/ndk/base/GvrLayout;->vrCoreSdkClient:Lcom/google/vr/ndk/base/VrCoreSdkClient;
    :try_end_0
    ...
    .line 305
    .end local v0    # "daydreamCompatibility":I
    .end local v1    # "enableSdkService":Z
    .end local v2    # "isDaydreamComponent":Z
    .end local v3    # "isDaydreamPhone":Z
    .end local v4    # "isDaydreamRequiredComponent":Z
    .end local v5    # "viewIndex":I
    .restart local p4    # "fadeOverlayView":Lcom/google/vr/ndk/base/FadeOverlayView;
    :cond_5
    :try_start_1
    invoke-virtual {p0}, Lcom/google/vr/ndk/base/GvrLayout;->getContext()Landroid/content/Context;
    ...
    invoke-static {v8}, Lcom/google/vr/ndk/base/GvrApi;->createDefaultDisplaySynchronizer(Landroid/content/Context;)Lcom/google/vr/cardboard/DisplaySynchronizer;
    ...
    .line 306
    :cond_6
    new-instance v8, Lcom/google/vr/cardboard/EglReadyListener;

    invoke-direct {v8}, Lcom/google/vr/cardboard/EglReadyListener;-><init>()V
    ...
    .line 307
    :cond_7
    new-instance v8, Lcom/google/vr/ndk/base/GvrApi;

    invoke-virtual {p0}, Lcom/google/vr/ndk/base/GvrLayout;->getContext()Landroid/content/Context;

    move-result-object v9

    invoke-direct {v8, v9, p2}, Lcom/google/vr/ndk/base/GvrApi;-><init>(Landroid/content/Context;Lcom/google/vr/cardboard/DisplaySynchronizer;)V
    ...
    .line 313
    :cond_8
    new-instance v8, Lcom/google/vr/ndk/base/DaydreamUtilsWrapper;

    invoke-direct {v8}, Lcom/google/vr/ndk/base/DaydreamUtilsWrapper;-><init>()V

    move-object p5, v8

    goto/16 :goto_3

    .restart local v0    # "daydreamCompatibility":I
    .restart local v3    # "isDaydreamPhone":Z
    .restart local v5    # "viewIndex":I
    :cond_9
    move v2, v1
    ...
    .restart local v2    # "isDaydreamComponent":Z
    :cond_a
    move v4, v1
    ...
    .line 349
    .restart local v1    # "enableSdkService":Z
    .restart local v4    # "isDaydreamRequiredComponent":Z
    :cond_b
    ...
    invoke-direct {p4, v7}, Lcom/google/vr/ndk/base/FadeOverlayView;-><init>(Landroid/content/Context;)V
    :try_end_1
...
.method static setPresentationFactory(Lcom/google/vr/ndk/base/GvrLayout$PresentationFactory;)V
    .locals 0
    .param p0, "factory"    # Lcom/google/vr/ndk/base/GvrLayout$PresentationFactory;
...
.method private tryCreatePresentationHelper()Lcom/google/vr/ndk/base/GvrLayout$PresentationHelper;
    ...
    .line 996
    .local v5, "externalDisplayName":Ljava/lang/String;
    if-nez v5, :cond_1
...
.method private updateFadeVisibility()V
    ...
    invoke-virtual {v1}, Lcom/google/vr/ndk/base/FadeOverlayView;->onVisible()V

    .line 1043
    iget-object v1, p0, Lcom/google/vr/ndk/base/GvrLayout;->showRenderingViewsRunnable:Ljava/lang/Runnable;

    invoke-virtual {p0, v1}, Lcom/google/vr/ndk/base/GvrLayout;->removeCallbacks(Ljava/lang/Runnable;)Z
    ...
    invoke-virtual {p0, v1, v2, v3}, Lcom/google/vr/ndk/base/GvrLayout;->postDelayed(Ljava/lang/Runnable;J)Z
    ...
    invoke-virtual {v1}, Lcom/google/vr/ndk/base/FadeOverlayView;->onInvisible()V

    .line 1053
    const/4 v1, 0x4

    invoke-direct {p0, v1}, Lcom/google/vr/ndk/base/GvrLayout;->updateRenderingViewsVisibility(I)V
...
.method private updateUiLayout()V
    ...
    .line 1062
    .end local v0    # "isDaydreamViewer":Z
    :cond_0
    const/4 v0, 0x0
...
.method protected createVrCoreSdkClient(Landroid/content/Context;Lcom/google/vr/ndk/base/GvrApi;Lcom/google/vr/ndk/base/DaydreamUtilsWrapper;Lcom/google/vr/ndk/base/FadeOverlayView;)Lcom/google/vr/ndk/base/VrCoreSdkClient;
    ...
    .param p1, "context"    # Landroid/content/Context;
    .param p2, "gvrApi"    # Lcom/google/vr/ndk/base/GvrApi;
    .param p3, "daydreamUtils"    # Lcom/google/vr/ndk/base/DaydreamUtilsWrapper;
    .param p4, "fadeOverlayView"    # Lcom/google/vr/ndk/base/FadeOverlayView;
    ...
    .line 858
    .local v5, "closeVrRunnable":Ljava/lang/Runnable;
...
.method public enableAsyncReprojectionVideoSurface(Lcom/google/vr/ndk/base/GvrLayout$ExternalSurfaceListener;Landroid/os/Handler;Z)Z
    ...
    .param p3, "useProtectedBuffers"    # Z
    ...
    .line 590
    iget-object v3, p0, Lcom/google/vr/ndk/base/GvrLayout;->daydreamUtils:Lcom/google/vr/ndk/base/DaydreamUtilsWrapper;

    invoke-virtual {p0}, Lcom/google/vr/ndk/base/GvrLayout;->getContext()Landroid/content/Context;

    move-result-object v4

    invoke-virtual {v3, v4}, Lcom/google/vr/ndk/base/DaydreamUtilsWrapper;->isDaydreamPhone(Landroid/content/Context;)Z
    ...
    const-string v3, "Only Daydream devices support async reprojection. Cannot enable video Surface."
    ...
    .line 596
    :cond_0
    iget-object v3, p0, Lcom/google/vr/ndk/base/GvrLayout;->scanlineRacingView:Lcom/google/vr/ndk/base/GvrLayout$AsyncReprojectionSurfaceView;
    ...
    const-string v3, "Async reprojection is already enabled. Cannot call enableAsyncReprojectionVideoSurface after calling setAsyncReprojectionEnabled."
    ...
    .line 604
    :cond_1
    iget-object v3, p0, Lcom/google/vr/ndk/base/GvrLayout;->gvrApi:Lcom/google/vr/ndk/base/GvrApi;

    invoke-virtual {v3}, Lcom/google/vr/ndk/base/GvrApi;->usingVrDisplayService()Z
    ...
    const-string v3, "Async reprojection video is not supported on this device."
    ...
    .line 609
    :cond_2
    iput-boolean v2, p0, Lcom/google/vr/ndk/base/GvrLayout;->isAsyncReprojectionVideoEnabled:Z

    .line 610
    iput-boolean p3, p0, Lcom/google/vr/ndk/base/GvrLayout;->isAsyncReprojectionUsingProtectedBuffers:Z

    .line 613
    new-instance v1, Lcom/google/vr/cardboard/ScanlineRacingRenderer;

    iget-object v3, p0, Lcom/google/vr/ndk/base/GvrLayout;->gvrApi:Lcom/google/vr/ndk/base/GvrApi;

    invoke-direct {v1, v3}, Lcom/google/vr/cardboard/ScanlineRacingRenderer;-><init>(Lcom/google/vr/ndk/base/GvrApi;)V

    iput-object v1, p0, Lcom/google/vr/ndk/base/GvrLayout;->scanlineRacingRenderer:Lcom/google/vr/cardboard/ScanlineRacingRenderer;

    .line 614
    iget-object v1, p0, Lcom/google/vr/ndk/base/GvrLayout;->scanlineRacingRenderer:Lcom/google/vr/cardboard/ScanlineRacingRenderer;

    invoke-virtual {v1}, Lcom/google/vr/cardboard/ScanlineRacingRenderer;->getExternalSurfaceManager()Lcom/google/vr/ndk/base/GvrLayout$ExternalSurfaceManager;

    move-result-object v0

    .line 615
    .local v0, "manager":Lcom/google/vr/ndk/base/GvrLayout$ExternalSurfaceManager;
    ...
    iput v1, p0, Lcom/google/vr/ndk/base/GvrLayout;->videoSurfaceId:I
...
.method public enableCardboardTriggerEmulation(Ljava/lang/Runnable;)Z
    .locals 3
    .param p1, "cardboardTriggerListener"    # Ljava/lang/Runnable;
...
.method public launchInVr(Landroid/app/PendingIntent;)V
    .locals 3
    .param p1, "openAppPendingIntent"    # Landroid/app/PendingIntent;

    .prologue
    .line 870
    iget-object v1, p0, Lcom/google/vr/ndk/base/GvrLayout;->vrCoreSdkClient:Lcom/google/vr/ndk/base/VrCoreSdkClient;

    if-eqz v1, :cond_0

    iget-object v1, p0, Lcom/google/vr/ndk/base/GvrLayout;->vrCoreSdkClient:Lcom/google/vr/ndk/base/VrCoreSdkClient;

    invoke-virtual {v1, p1}, Lcom/google/vr/ndk/base/VrCoreSdkClient;->launchInVr(Landroid/app/PendingIntent;)Z
...
.method public setAsyncReprojectionEnabled(Z)Z
    ...
    const-string v2, "setAsyncReprojectionEnabled may only be called from the UI thread"
    ...
    const-string v2, "Async reprojection cannot be disabled once enabled"
    ...
    invoke-virtual {v2, p1}, Lcom/google/vr/ndk/base/GvrApi;->setAsyncReprojectionEnabled(Z)Z
