...
.method public constructor <init>(Landroid/content/Context;Lcom/google/vr/ndk/base/GvrApi;)V
    ...
    iput-object v3, p0, Lcom/google/vr/ndk/base/DaydreamTouchListener;->pixelTranslation:[F

    .line 53
    iput-boolean v1, p0, Lcom/google/vr/ndk/base/DaydreamTouchListener;->enabled:Z

    .line 55
    new-array v3, v4, [F

    iput-object v3, p0, Lcom/google/vr/ndk/base/DaydreamTouchListener;->lastTranslation:[F

    .line 56
    new-array v3, v4, [F

    iput-object v3, p0, Lcom/google/vr/ndk/base/DaydreamTouchListener;->translation:[F
    ...
    iget-object v3, v3, Lcom/google/common/logging/nano/Vr$VREvent$SdkConfigurationParams;->daydreamImageAlignment:Ljava/lang/Integer;
    ...
    :goto_0
    iput-boolean v1, p0, Lcom/google/vr/ndk/base/DaydreamTouchListener;->isDaydreamImageAlignmentEnabled:Z
    ...
    iput-object v1, p0, Lcom/google/vr/ndk/base/DaydreamTouchListener;->vrParamsProvider:Lcom/google/vr/cardboard/VrParamsProvider;
    ...
    invoke-direct {v0, p0, v1}, Lcom/google/vr/ndk/base/DaydreamTouchListener$FinishInitilizationTask;-><init>(Lcom/google/vr/ndk/base/DaydreamTouchListener;Lcom/google/vr/ndk/base/DaydreamTouchListener$1;)V

    .line 71
    .local v0, "task":Lcom/google/vr/ndk/base/DaydreamTouchListener$FinishInitilizationTask;
    invoke-static {p1}, Lcom/google/vr/cardboard/DisplayUtils;->getDefaultDisplay(Landroid/content/Context;)Landroid/view/Display;

    move-result-object v1

    iput-object v1, v0, Lcom/google/vr/ndk/base/DaydreamTouchListener$FinishInitilizationTask;->display:Landroid/view/Display;
    ...
    .end local v0    # "task":Lcom/google/vr/ndk/base/DaydreamTouchListener$FinishInitilizationTask;
    :cond_0
    move v1, v2
...
.method constructor <init>(Lcom/google/vr/cardboard/VrParamsProvider;Landroid/util/DisplayMetrics;Lcom/google/vrtoolkit/cardboard/proto/nano/Phone$PhoneParams;Lcom/google/vr/ndk/base/GvrApi;Z)V
    .locals 2
    .param p1, "vrParamsProvider"    # Lcom/google/vr/cardboard/VrParamsProvider;
    .param p2, "displayMetrics"    # Landroid/util/DisplayMetrics;
    .param p3, "phoneParams"    # Lcom/google/vrtoolkit/cardboard/proto/nano/Phone$PhoneParams;
    .param p4, "gvrApi"    # Lcom/google/vr/ndk/base/GvrApi;
    .param p5, "isDaydreamImageAlignmentEnabled"    # Z
...
.method static synthetic access$1000(Lcom/google/vr/ndk/base/DaydreamTouchListener;Landroid/util/DisplayMetrics;Lcom/google/vrtoolkit/cardboard/proto/nano/Phone$PhoneParams;)V
    .locals 0
    .param p0, "x0"    # Lcom/google/vr/ndk/base/DaydreamTouchListener;
    .param p1, "x1"    # Landroid/util/DisplayMetrics;
    .param p2, "x2"    # Lcom/google/vrtoolkit/cardboard/proto/nano/Phone$PhoneParams;
...
.method private init(Landroid/util/DisplayMetrics;Lcom/google/vrtoolkit/cardboard/proto/nano/Phone$PhoneParams;)V
    ...
    .param p2, "phoneParams"    # Lcom/google/vrtoolkit/cardboard/proto/nano/Phone$PhoneParams;
...
.method public processMotionEvent(Landroid/view/MotionEvent;)Z
    ...
    .prologue
    .line 124
    invoke-virtual/range {p0 .. p0}, Lcom/google/vr/ndk/base/DaydreamTouchListener;->viewerNeedsTouchProcessing()Z
    ...
    iput-boolean v14, v0, Lcom/google/vr/ndk/base/DaydreamTouchListener;->lastMotionEventInHeadset:Z
    ...
    .line 129
    :cond_0
    invoke-virtual/range {p0 .. p0}, Lcom/google/vr/ndk/base/DaydreamTouchListener;->isDaydreamImageAlignmentEnabled()Z
    ...
    .line 139
    .local v9, "numPointers":I
    move-object/from16 v0, p0

    iget v14, v0, Lcom/google/vr/ndk/base/DaydreamTouchListener;->mostTouchesSeen:I
    ...
    iput-object v14, v0, Lcom/google/vr/ndk/base/DaydreamTouchListener;->touchBestMarker:[I

    .line 141
    move-object/from16 v0, p0

    iput v9, v0, Lcom/google/vr/ndk/base/DaydreamTouchListener;->mostTouchesSeen:I
    ...
    iget-object v14, v0, Lcom/google/vr/ndk/base/DaydreamTouchListener;->markersInPixels:[[F
    ...
    iget-object v14, v0, Lcom/google/vr/ndk/base/DaydreamTouchListener;->markerBestTouch:[I
    ...
    iget-object v14, v0, Lcom/google/vr/ndk/base/DaydreamTouchListener;->currentMarkerBestDists:[D

    const-wide v16, 0x3f2d7dbf487fcb92L    # 2.25E-4
    ...
    .line 153
    .local v2, "currentTouchBestDist":D
    move-object/from16 v0, p0

    iget-object v14, v0, Lcom/google/vr/ndk/base/DaydreamTouchListener;->touchBestMarker:[I
    ...
    iget v15, v0, Lcom/google/vr/ndk/base/DaydreamTouchListener;->xMetersPerPixel:F
    ...
    iget v15, v0, Lcom/google/vr/ndk/base/DaydreamTouchListener;->yMetersPerPixel:F
    ...
    .line 151
    .end local v4    # "dist":D
    .end local v12    # "xDelta":F
    .end local v13    # "yDelta":F
    :cond_6
    add-int/lit8 v6, v6, 0x1
    ...
    .line 169
    .end local v2    # "currentTouchBestDist":D
    .end local v7    # "j":I
    :cond_7
    const/4 v10, 0x0
    ...
    iget-object v15, v0, Lcom/google/vr/ndk/base/DaydreamTouchListener;->markerBestTouch:[I
    ...
    iget-object v15, v0, Lcom/google/vr/ndk/base/DaydreamTouchListener;->markersInPixels:[[F
    ...
    iget-object v14, v0, Lcom/google/vr/ndk/base/DaydreamTouchListener;->pixelTranslation:[F
